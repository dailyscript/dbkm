...
INSERT INTO `menu` VALUES (1,NULL,NULL,'Dashboard','#',10,'icon-home',1,1),(2,1,2,'Dashboard','dashboard/',11,'icon-home',1,1),(3,NULL,NULL,'Sistema','#',900,'icon-cogs',1,1),(4,3,4,'Accesos','sistema/acceso/listar/',901,'icon-exchange',1,1),(5,3,5,'Auditorías','sistema/auditoria/listar/',902,'icon-eye-open',1,1),(6,3,6,'Backups','sistema/backup/listar/',903,'icon-hdd',1,1),(7,3,7,'Mantenimiento','sistema/mantenimiento/',904,'icon-bolt',1,1),(8,3,8,'Menús','sistema/menu/listar/',905,'icon-list',1,1),(9,3,9,'Perfiles','sistema/perfil/listar/',906,'icon-group',1,1),(10,3,10,'Permisos','sistema/privilegio/listar/',907,'icon-magic',1,1),(11,3,11,'Recursos','sistema/recurso/listar/',908,'icon-lock',1,1),(12,3,12,'Usuarios','sistema/usuario/listar/',909,'icon-user',1,1),(13,3,13,'Visor de sucesos','sistema/sucesos/listar/',910,'icon-filter',1,1),(14,3,14,'Sistema','sistema/configuracion/',911,'icon-wrench',1,1),(15,NULL,NULL,'Configuraciones','#',800,'icon-wrench',1,1),(16,15,15,'Empresa','config/empresa/',801,'icon-briefcase',1,1),(17,15,16,'Sucursales','config/sucursal/listar/',802,'icon-sitemap',1,1);
